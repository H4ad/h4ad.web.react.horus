...
import * as localeUS from 'date-fns/locale/en-US';

const dealLocal = function dealLocal(str) {
  return localeUS.default;
};

const localeParse = function localeParse(format) {
